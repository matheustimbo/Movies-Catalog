...
export default class Home extends Component {
    ...
    renderHeader = (isAbsolute) => {
        return(
            <View style={[styles.moviesListOptions, isAbsolute && this.state.headerFixed ? styles.headerFixedStyle : {}]}>
                <TouchableOpacity
                    onPress={() => {
        ...
        return (
            <View style={{ flex: 1, backgroundColor: '#EDEEF2' }}>
                ...
                <SafeAreaView style={{ flex:1, backgroundColor: '#EDEEF2' }}>
                    ...
                    {this.state.headerFixed && this.renderHeader(true)}
